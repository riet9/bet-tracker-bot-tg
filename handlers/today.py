...
async def prompt_button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'prompt_morning':
        text = (
            "Я разбираюсь только в футболе, хоккее и CS2. Но это не особо важно.\n\n"
        ...
        text = (
            "Я разбираюсь только в футболе, хоккее и CS2.Но это не особо важно.\n\n"
            f"Найди ещё, если есть 1–3 логичных ставок (#value, #sharp, #wildcard) на вечер сегодня ({today}) и/или ночь, и/или утро следующего дня до 09:00.\n\n"
